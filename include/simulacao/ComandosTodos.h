...
public:
    ...
    string getNome() override { return "avanca"; }
};
...
public:
    ...
    void executa(Simulador &sim, std::istringstream & params) const override;
    string getNome() override { return "jardim"; }
};
...
public:
    ...
    void executa(Simulador &sim, std::istringstream & params) const override;
    string getNome() override { return "grava"; }
};
...
public:
    ...
    void executa(Simulador &sim, std::istringstream & params) const override;
    string getNome() override { return "recupera"; }
};
...
public:
    ...
    void executa(Simulador &sim, std::istringstream & params) const override;
    string getNome() override { return "apaga"; }
};
...
public:
    ...
    void executa(Simulador &sim, std::istringstream & params) const override;
    string getNome() override { return "executa"; }
};
...
public:
    ...
    void executa(Simulador &sim, std::istringstream & params) const override;
    string getNome() override { return "lplantas"; }
};
...
public:
    ...
    void executa(Simulador &sim, std::istringstream & params) const override;
    string getNome() override { return "lplanta"; }
};
...
public:
    ...
    void executa(Simulador &sim, std::istringstream & params) const override;
    string getNome() override { return "larea"; }
};
...
public:
    ...
    void executa(Simulador &sim, std::istringstream & params) const override;
    string getNome() override { return "lsolo"; }
};
...
public:
    ...
    void executa(Simulador &sim, std::istringstream & params) const override;
    string getNome() override { return "lferr"; }
};
...
public:
    ...
    void executa(Simulador &sim, std::istringstream & params) const override;
    string getNome() override { return "colhe"; }
};
...
public:
    ...
    void executa(Simulador &sim, std::istringstream & params) const override;
    string getNome() override { return "planta"; }
};
...
public:
    ...
    void executa(Simulador &sim, std::istringstream & params) const override;
    string getNome() override { return "larga"; }
};
...
public:
    ComandoPega() = default;
    void executa(Simulador &sim, std::istringstream & params) const override;
    string getNome() override { return "pega"; }
};
...
public:
    ...
    void executa(Simulador &sim, std::istringstream & params) const override;
    string getNome() override { return "compra"; }
};
...
public:
    ...
    void executa(Simulador &sim, std::istringstream & params) const override;
    string getNome() override { return "e"; }
};
...
public:
    ...
    void executa(Simulador &sim, std::istringstream & params) const override;
    string getNome() override { return "d"; }
};
...
public:
    ...
    void executa(Simulador &sim, std::istringstream & params) const override;
    string getNome() override { return "c"; }
};
...
public:
    ...
    void executa(Simulador &sim, std::istringstream & params) const override;
    string getNome() override { return "b"; }
};
...
public:
    ...
    void executa(Simulador & sim, std::istringstream & params) const override;
    string getNome() override { return "entra"; }
};
...
public:
    ComandoSai() = default;
    void executa(Simulador &sim, std::istringstream & params) const override;
    string getNome() override { return "sai"; }
};
...
public:
    ComandoFim() = default;
    void executa(Simulador &sim, std::istringstream & params) const override;
    string getNome() override { return "fim"; }
};
